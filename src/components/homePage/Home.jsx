...
import { DEFAULT_ACTIVE_PAGE, DEFAULT_DRAWER_FLAG, DEFAULT_SIDE_MENU, IconTileMap } from '../../Utils/Constants';
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={drawerOpen}>
        <DrawerHeader>
          <h1 style={{marginRight: 'auto', marginLeft: '2%'}} >Porfolio</h1>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        <DrawerHeader />
        {
          ...
          :
          <div style={{padding: '1%'}}>
            <Skeleton sx={{mb: 1, width: '98%'}} variant="rectangular" height={80} />
            <Skeleton sx={{mb: 1, width: '90%'}} variant="rectangular" height={100} />
            <Skeleton sx={{mb: 1, width: '100%'}} variant="rectangular" height={210} />
          </div>
        }
